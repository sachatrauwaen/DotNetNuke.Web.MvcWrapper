...
namespace Satrabel.Web.MvcPipeline.Modules
{
    using System;
    ...
    {
        /// <summary>
        /// Creates a DNN skin message panel with optional heading.
        /// </summary>
        ...
        /// <param name="autoScroll">Whether to automatically scroll to the message (note: auto-scroll is simplified in this version).</param>
            ...
            object htmlAttributes = null)
        {
            ...
            // Add inline auto-scroll script if requested (simplified version without MvcClientAPI)
            if (autoScroll)
            {
                result += @"
